...
$DBversion = "3.22.01.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (Koha 3.22.1)\n";
    SetVersion($DBversion);
}

$DBversion = "3.22.01.001";
if ( CheckVersion($DBversion) ) {
    $dbh->do(q{
        INSERT IGNORE INTO systempreferences
        (`variable`, `value`, `explanation`, `options`, `type`)
    ...
    print "Upgrade to $DBversion done (Bug 13022 - Hardcoded limit causes records with more than 20 items to show inaccurate statuses)\n";
    SetVersion($DBversion);
}
...
$DBversion = "3.22.03.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (Koha 3.22.3)\n";
    SetVersion($DBversion);
}
...
$DBversion = "3.22.11.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (Koha 3.22.11)\n";
    SetVersion($DBversion);
}
