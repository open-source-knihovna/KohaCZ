...
$DBversion = "16.05.13.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (Koha 16.05.13)\n";
    SetVersion($DBversion);
}

$DBversion = "16.05.14.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (Koha 16.05.14)\n";
    SetVersion($DBversion);
}
...
$DBversion = "16.05.15.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (Koha 16.05.15)\n";
    SetVersion($DBversion);
}

$DBversion = "16.05.16.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (Koha 16.05.16)\n";
    SetVersion($DBversion);
}

$DBversion = "16.05.17.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (Koha 16.05.17)\n";
    SetVersion($DBversion);
}
