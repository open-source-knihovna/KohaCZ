...
$DBversion = "16.11.02.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (Koha 16.11.02)\n";
    SetVersion($DBversion);
}
...
$DBversion = "16.11.10.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (Koha 16.11.10)\n";
    SetVersion($DBversion);
}
...
$DBversion = "16.11.12.000";
if ( CheckVersion($DBversion) ) {
    print "Upgrade to $DBversion done (Koha 16.11.12)\n";
    SetVersion($DBversion);
}
