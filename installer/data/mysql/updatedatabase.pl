...
$DBversion = "17.05.01.000";
if ( CheckVersion($DBversion) ) {
    SetVersion($DBversion);
    print "Upgrade to $DBversion done (Koha 17.05.01)\n";
}

$DBversion = "17.05.02.000";
if ( CheckVersion($DBversion) ) {
    SetVersion($DBversion);
    print "Upgrade to $DBversion done (Koha 17.05.02)\n";
}

$DBversion = "17.05.03.000";
if ( CheckVersion($DBversion) ) {
    SetVersion($DBversion);
    print "Upgrade to $DBversion done (Koha 17.05.03)\n";
}

$DBversion = "17.05.04.000";
if ( CheckVersion($DBversion) ) {
    SetVersion($DBversion);
    print "Upgrade to $DBversion done (Koha 17.05.04)\n";
}
...
$DBversion = "17.05.08.000";
if ( CheckVersion($DBversion) ) {
    SetVersion($DBversion);
    print "Upgrade to $DBversion done (Koha 17.05.08)\n";
}

$DBversion = '17.05.08.001';
if( CheckVersion( $DBversion ) ) {
