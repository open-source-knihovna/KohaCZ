...
('CheckPrevIssueSerialFrameworks','PE','','List of serial frameworks codes (separated by |)','free'),
...
('UseConspectusMethod','0','','Whether to use Conspectus method in cataloguing - Czech Republic only','YesNo'),
